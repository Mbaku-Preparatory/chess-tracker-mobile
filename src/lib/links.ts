 ...
 *
 * The host is `mbaku-preparatory.vercel.app` — note that the older
 * `chess-tracker-frontend.vercel.app` is NOT ours and now serves an unrelated
 * chess site. See RELEASING.md.
 */

export const PRIVACY_POLICY_URL = "https://mbaku-preparatory.vercel.app/privacy";
...
export function accountDeletionMailto(username: string): string {
  ...
  const body = encodeURIComponent(
    `Please delete my Mbaku Preparatory account and all data associated with it.\n\n` +
      `Username: ${username}\n\n` +
